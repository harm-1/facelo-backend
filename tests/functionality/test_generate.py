...
from facelo.challenge.generate import (created_challenges_list, gen_random,
                                       gen_sametrial)
from facelo.challenge.views import get_recent_challenges
...
class TestGenerate:
    ...
    def test_gen_chall_data_random(self, user, question):
        ...
        existing_challs = created_challenges_list(
            get_recent_challenges(user, question, 62))
